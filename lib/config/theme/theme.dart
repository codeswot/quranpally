...
class AppMaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.light,
      primary: Color(0xff693507),
      surfaceTint: Color(0xff8a5022),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa46536),
      ...
      inverseOnSurface: Color(0xfffeeee4),
      inversePrimary: Color(0xffffb784),
      primaryFixed: Color(0xffa46536),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff874e20),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff8a5022),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff693507),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(0xffffbd8f),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xfffffaf8),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xffe9c3ac),
      onSecondaryContainer: Color(0xff000000),
